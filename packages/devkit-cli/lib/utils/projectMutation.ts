...
import { FileManager, BUNDLER_PACKAGE_MAP, resolveBundlerName } from "@devkit/shared-utils";
import type { IBundlerName } from "@devkit/shared-utils";

/**
 * 读取 @devkit/cli 自身的版本号
 *
 * 实现策略：
...
export function readCliVersion(): string {
    try {
        ...
        const pkgJsonPath = require.resolve("@devkit/cli/package.json", {
            paths: [process.cwd()],
        });
 ...
 * @param bundlerInput bundler 短名 / "bundler-xxx" / "@devkit/bundler-xxx"
