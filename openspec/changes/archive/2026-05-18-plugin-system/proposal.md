...
- Affected packages: `@devkit/plugin-react`, `@devkit/plugin-mock`, `@devkit/plugin-request`
- Dependencies: `json-server` (already in mock plugin), `axios`, `@devkit/shared-utils`
