...
- New package `@bundlekit/plugin-vue` providing Vue 3 build config injection and templates
...
- Vue 3 project structure: `src/App.vue`, `src/main.ts`, and Vite-based `.bundlekitrc.ts`
...
- New packages: `@bundlekit/plugin-vue`
- Modified packages: `@bundlekit/cli` (template list + dependency), `@bundlekit/plugin-vue/templates/`
